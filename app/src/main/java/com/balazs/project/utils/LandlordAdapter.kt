...
class LandlordAdapter(private val images: List<DataLandlord>) :
    ...
    class ImageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val iv_photo: ImageView = itemView.findViewById(R.id.iv_mock_landlord)
        val iv_icon: ImageView = itemView.findViewById(R.id.iv_right_landlord)
        val txt_title: TextView = itemView.findViewById(R.id.txt_title_landlord)
        val txt_price: TextView = itemView.findViewById(R.id.txt_price_landlord)
        val txt_name: TextView = itemView.findViewById(R.id.txt_name_landlord)
